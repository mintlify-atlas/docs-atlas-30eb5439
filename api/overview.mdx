...
<Card title="Get Version" icon="database" href="#data-dragon-version">
  Retrieve the latest Data Dragon version for champion assets
</Card>

## Data Dragon Version

<Endpoint method="GET" path="/api/ddragon/version" />
...
// Use version to construct champion icon URL
const championIcon = `https://ddragon.leagueoflegends.com/cdn/${version}/img/champion/Ahri.png`;
```
</CodeGroup>
